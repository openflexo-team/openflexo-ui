...
public interface BugReportPreferences extends ServicePreferences<BugReportService> {
	...
	/** @deprecated kept for XML deserialization compatibility only */
	@Deprecated
	...
	@Getter(value = GITHUB_TOKEN_KEY, defaultValue = "")
	@XMLAttribute
	public String getGithubToken();

	@Setter(GITHUB_TOKEN_KEY)
	public void setGithubToken(String token);

	/** @deprecated Use {@link #getGithubToken()} instead. */
	@Deprecated
	@Getter(value = BUG_REPORT_URL_KEY, defaultValue = "")
	@XMLAttribute
	...
	public void setBugReportUrl(String url);

	/** @deprecated Use {@link #getGithubToken()} instead. */
	@Deprecated
	@Getter(value = BUG_REPORT_USER, defaultValue = "")
	@XMLAttribute
	...
	/** @deprecated Use {@link #getGithubToken()} instead. */
	@Deprecated
	@Getter(value = BUG_REPORT_PASSWORD, defaultValue = "")
	@XMLAttribute
